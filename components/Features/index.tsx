...
const Features = () => {
  return (
    <>
      <section id="secure-scan-api" className={styles.features}>
      ...
      <section id="display-api" className={styles.features}>
        <div className={styles.feature}>
          <div className="flex items-center">
            <div className="rounded-r-none overflow-hidden">
              <Image
            ...
            <div className="flex-1 flex flex-col p-14">
              <h3 className="text-4xl font-semibold text-left">Display API</h3>
              <div className="text-left text-xl mt-5">
                <p>
                  Extracts Account Changes from Complex Transaction Data, Making
      ...
      <section id="risk-control-rpc-services" className={styles.features}>
        <div className={styles.feature}>
          <div className="flex items-center">
            <div className="rounded-r-none overflow-hidden">
              <Image
            ...
            <div className="flex-1 flex flex-col p-14">
              ...
              <div className="text-left text-xl mt-5">
                <p>
                  Offers a Variety of Risk Control Strategies, Intercepts Risky
                  Transactions, and Allows Users to Customize Strategy
                  Combinations.
                </p>
              </div>
              <div className="flex mt-10">
